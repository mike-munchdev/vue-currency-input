    ...
    <v-container fluid>
      <v-row>
        <v-col class="d-flex" cols="12" sm="6">
          <v-currency-field v-model="value" :options="options" />
        </v-col>
      ...
      <v-row>
        <v-col cols="12" sm="6">
          ...
          <div class="d-flex align-center justify-space-between">
            ...
            <v-switch v-model="useGrouping" class="my-0" hide-details />
          </div>
          <div class="mt-4 mb-10">
            Whether to use grouping separators such as thousands/lakh/crore
            separators.
          </div>
          <div class="d-flex align-center justify-space-between">
            <span class="title">Distraction Free</span>
            <v-switch v-model="distractionFree" class="my-0" hide-details />
          </div>
          <div class="my-4">
            Enables easier input by hiding various parts of the formatting on
            focus.
          </div>
          <v-checkbox
        ...
        <v-col cols="12" sm="6">
          <div class="d-flex align-center justify-space-between mb-4">
            ...
            <v-switch v-model="precisionEnabled" class="my-0" hide-details />
          </div>
          <div class="mb-6">
            Override the number of displayed decimal digits. Can only be applied
            for currencies that support decimal digits.
          </div>
          <v-switch
          ...
          <div class="mb-8">
            The validation is triggered on blur and automatically sets the
            respective threshold if out of range.
          </div>
          <v-range-slider
            v-model="valueRange"
          ...
          <div class="mb-6">
            Whether the decimal symbol is inserted automatically, using the last
            inputted digits as decimal digits.
          </div>
          ...
          <div class="mb-6">
            Whether the number value should be handled as integer instead of a
            float value.
          </div>
          <div class="d-flex align-center justify-space-between">
            <span class="title">Always Hide Currency Symbol</span>
            <v-switch v-model="alwaysHideCurrencySymbol" />
          </div>
          <div class="mb-6">
            Whether the currency symbol should always be hidden.
          </div>
        </v-col>
      </v-row>
    </v-container>
  ...
  computed: {
    options() {
      return {
        ...
        alwaysHideCurrencySymbol: this.alwaysHideCurrencySymbol,
      };
    },
  },
};
